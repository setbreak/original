...
//		button2.style.object.display.opacity = "100%";
        ...
        // commented out on 052714
        
        //        var thenewurl = 'http://setbreakmusic.com/drupal/concerts/todayfeedwithpicDeadDose.php';

        
// theDeadnewurl is set in the atttibutes file
        
        var thenewurl = theDeadnewurl;
		searchfield.value = "";
		filterString = searchfield.value;          
...
//        var thenewurl = 'http://setbreakmusic.com/drupal/concerts/todayfeedwithpic0707.php';
        ...
        // theArchivenewurl is set in the atttibutes file

        var thenewurl = theArchivenewurl;
		searchfield.value = "";
		filterString = searchfield.value;          
    setFeedSource(thenewurl);
    document.getElementById("StackLayout").object.setCurrentView("progressLoad", true);
...
// newSongListBaseurl is set in the atttibutes file

        
        
        var newurl = newSongListBaseurl + 'inputfile=' + extractText( feedResults[this._representedObject].ident );
...
// this line was not commented out lyrics.innerHTML = '';
// this line was not commented out	lyrics.style.display = "none";
